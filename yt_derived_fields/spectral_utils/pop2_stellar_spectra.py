...
def get_pop_2_spectrum(data, combined=True, lmin=1150, lmax=10000, downsample=True, ds_nwv=5, n_batch=5000, ncpu_max=10):
    """
    ...
    def batch_interp(c1, c2):
        return spec_interp_p2(
            to_interp[c1:c2, :]
        ) * initial_masses[c1:c2, None]
